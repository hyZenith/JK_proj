    ...
    <div>
      <InfoPagesLayout activePage="search-suppliers">
        <div className="search-suppliers__container">
          <div>
            <h1 className="search-suppliers__title">
              Search smarter, not harder
            </h1>
            <p className="search-suppliers__subtitle">
              This is how you find the right supplier faster and more
              efficiently.
            </p>
            ...
            <p className="search-suppliers__intro">
              ...
              certifications to locate suppliers who meet your exact
              requirements. Each supplier profile provides detailed information,
              so you can make quick, informed decisions.
            </p>
          </div>
      ...
      <div className="browse-Product">
        <div className="browse-Product__content">
          <div className="browse-Product__text">
            <h2 className="browse-Product__title">
            ...
            <button className="browse-Product__button">
              Browse all products
            </button>
          </div>
